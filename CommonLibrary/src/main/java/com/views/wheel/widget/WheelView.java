...
package com.views.wheel.widget;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { Color.parseColor("#00000000"),
	...
	// Wheel drawables
	private int wheelBackground = R.color.layout_bg;
	private int wheelForeground = R.drawable.icon_wv_bg;
