...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected int cancelTextColor = activity.getResources().getColor(R.color.grey);
    protected int submitTextColor = activity.getResources().getColor(R.color.blue);
    protected int titleTextColor = activity.getResources().getColor(R.color.grey);
