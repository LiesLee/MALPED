...
public class TouchCircleView extends View {
    ...
    private String color1 = "#bb9a55";
    private String color2 = "#1c1c1c";
...
//                    , centerY + outCirRadius + currentOffset + outCirRadius * 2);
    ...
    private void initPaintPath() {
        ...
        secPaint.setColor(Color.parseColor(color1));
        //Loding过程的圈圈
        mixPaint = new Paint(paint);
        innerPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        innerPaint.setStyle(Paint.Style.STROKE);
        innerPaint.setAntiAlias(true);
        innerPaint.setColor(Color.parseColor(color1));
        ...
        mHookPaint.setColor(Color.parseColor(color1));
    ...
    private void setupAnimations() {
        ...
        translateAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                //过度颜色
                if (!isBack) {
                    mixPaint.setColor(ColorUtils.blendARGB(Color.parseColor(color2), Color.parseColor(color1), tranlateFraction));
                    mCurrentRadius = (int) (outCirRadius + tranlateFraction * (secondRadius - outCirRadius));
                } else {
                    mixPaint.setColor(ColorUtils.blendARGB(Color.parseColor(color1), Color.parseColor(color2), tranlateFraction));
